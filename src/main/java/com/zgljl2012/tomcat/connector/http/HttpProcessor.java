...
import com.zgljl2012.tomcat.util.CookieTools;
...
public class HttpProcessor {
	 ...
	 */
	protected StringManager sm = StringManager.getManager("com.zgljl2012.tomcat.connector.http");
	...
	private void parseHeaders(SocketInputStream input) throws IOException, ServletException {
		while (true) {
			...
			if (name.equals("cookie")) {
				Cookie cookies[] = CookieTools.parseCookieHeader(value);
